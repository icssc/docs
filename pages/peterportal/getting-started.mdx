...
1. Create a `.env` file in the `api` directory with the necessary environment variables as provided by the project lead or documented below for open-source contributors.

For Open Source Contributors, your `.env` file should include:
