...
<Steps>
    <Step>
        Please make sure you have read the [Attribution Policy](/docs/about/anteaterapi/attribution-policy) in its entirety. By continuing, you represent that you have done so and accept its provisions.
    </Step>
    <Step>
