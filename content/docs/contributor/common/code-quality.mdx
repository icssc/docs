...
In practice, this means trivial items like formatting and linting should always be easy. Refer to our [common toolchain](/docs/contributor/common/toolchain) for what tools we use where. This ensures that feedback is instant and automatic, while keeping our code review cycles for more meaningful discussions.
