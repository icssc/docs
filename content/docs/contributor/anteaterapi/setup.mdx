...
1. Clone the repository and change into it. In your command line:
...
5. Start the local Postgres database. If you are using Docker Compose, as we recommend above, this is simple:
